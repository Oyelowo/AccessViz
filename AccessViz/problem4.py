...
class visual_comp:
    def vis_compare(data_zip,userinput, filepath, grid_shp, compare_mod=['',''], map_type='interactive', destination_style='grid',        
           ...
           print("WARNING: More than two travel modes are not allowed")
            ...
            for element in userinput:
                ...
                if element_file not in namelist:
                    ...
                    if all(x in [i for i in tt_matrices.columns] for x in compare_mod)==False:
                        print('at least, one of the specified modes are not available')
